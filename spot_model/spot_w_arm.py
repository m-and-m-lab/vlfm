"""Configuration for the Boston Dynamics robot with arm.
...
# Construct the relative path to the spot_arm_w_cam.usd file
usd_file_path = os.path.join(current_dir, "spot_arm_w_cam.usd")
...
SPOT_ARM_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.7),
        joint_pos={
            # Leg joints - Assuming standard standing pose
            ".*_left_hip_x": 0.1,
            ".*_right_hip_x": -0.1,
            "front_.*_hip_y": 0.9,
            "rear_.*_hip_y": 1.1,
            ...
            # Arm joints - Stowed/Home position
            "arm_sh0": 0.0,
            "arm_sh1": -3.1,
            "arm_el0": 3.1,
            "arm_el1": 0.0,
